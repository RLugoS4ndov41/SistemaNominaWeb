            ...
            <div class="logo">
                <a href="https://www.lexsoft.com.mx" class="simple-text logo-mini">
                  <div class="logo-image-small">
                    <img src="./imagenes/lexsoft.bmp" width="800" height="50">
                  </div>
                  <!-- <p>CT</p> -->
                </a>
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid"> 
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:;">Listado de Empresas:</a>
                </div>
            </nav>
            ...
            <form action="menu.php" method="POST">
                <table class="table table-hover">
                    ...
                    <tbody>
                          ...
                          <tr>
                              <td>1</td>
                              <td>AAAA010101A010</td>
                              <td>Empresa de Prueba 1</td>
                              <td>2021</td>
                              <td><input type="submit" value="Seleccionar" Name="numero" class="btn btn-primary btn-round">
                             <!-- <td><button class="btn btn-primary btn-round">Seleccionar</button></td>-->
                          </tr>      
                          <tr>
                             <td>2</td>
                              <td>XXXX010101A010</td>
                              <td>Empresa de Prueba 2</td>
                              <td>2022</td>
                              <td><input type="submit" value="Seleccionar" Name="numero" class="btn btn-primary btn-round">
                             <!-- <td><button class="btn btn-primary btn-round">Seleccionar</button></td>-->
                          </tr>
                ...
                <!-- <h6 class="card-title">Listado de Empresas</h6>-->
            </div>
                ...
                <form>
                  ...
                  <div class="row">     <!-- Renglon de Domicilio-->
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Calle" value="">
                      </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>No.Exterior</label>
                          <input type="text" class="form-control" placeholder="No.Exterior" value="">
                        </div>
                      </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>No.Inteior</label>
                          <input type="text" class="form-control" placeholder="No.Interior" value="">
                        </div>
                     </div>
                  </div>
                  <div class="row">    <!-- Renglon de Colonia-->
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        <label>Colonia</label>
                        <input type="text" class="form-control" placeholder="Colonia" value="">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Cod.Postal</label>
                        <input type="text" class="form-control" placeholder="Codigo Postal" value="">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                  ...
                  <div class="row">    <!-- Renglon del Municipio-->
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Municipio" value="">
                      </div>
                    </div>
                    <div class="col-md-4 px-1">
                      <div class="form-group">
                        <label>Estado:</label>
                        <input type="text" class="form-control" placeholder="Estado" value="">
                      </div>
                    </div>
                    <div class="col-md-4 pl-1">
                      <div class="form-group">
                        <label>Pais:</label>
                        <input type="number" class="form-control" placeholder="Pais" value="">
                      </div>
                    </div>
                  </div>
                  <div class="row">    <!-- Renglon del Regimen-->
                    ...
                    <div class="col-md-3 px-1">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" placeholder="Lugar de Expedicion" value="">
                        </div>
                      </div>
                  </div>
